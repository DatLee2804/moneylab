      ...
      <div className="max-w-7xl mx-auto space-y-8 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-[#133E2B] p-10 rounded-[40px] text-[#0a0a0a] relative overflow-hidden shadow-2xl shadow-[#133E2B]/20 font-sans">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="px-8 py-4 bg-white text-[#1C221F] font-black rounded-2xl hover:bg-gray-900 transition-all shadow-xl flex items-center justify-center space-x-2">
                    <Banknote size={20} />
            ...
            <div className="bg-white p-10 rounded-[40px] border border-[#E8E3D9] shadow-sm">
              <h3 className="text-xl font-black text-[#1C221F] mb-8">Thông tin tài khoản ngân hàng</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-2">Ngân hàng</label>
                  <input type="text" readOnly value={user?.bankName || 'Chưa cập nhật'} className="w-full px-6 py-4 bg-white border border-[#E8E3D9] rounded-2xl text-sm font-bold text-[#1C221F] outline-none" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-2">Số tài khoản</label>
                  <input type="text" readOnly value={user?.bankAccount || 'Chưa cập nhật'} className="w-full px-6 py-4 bg-white border border-[#E8E3D9] rounded-2xl text-sm font-bold text-[#1C221F] outline-none" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-2">Chủ tài khoản</label>
                  <input type="text" readOnly value={user?.bankOwner || 'Chưa cập nhật'} className="w-full px-6 py-4 bg-white border border-[#E8E3D9] rounded-2xl text-sm font-bold text-[#1C221F] outline-none" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-2">Chi nhánh</label>
                  <input type="text" readOnly value={user?.bankBranch || 'Chưa cập nhật'} className="w-full px-6 py-4 bg-white border border-[#E8E3D9] rounded-2xl text-sm font-bold text-[#1C221F] outline-none" />
                </div>
              </div>
              <button className="mt-10 px-10 py-4 bg-white/5 text-gray-500 font-black rounded-2xl hover:bg-white/10 transition-all border border-[#E8E3D9] text-xs uppercase tracking-widest">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-[40px] border border-[#E8E3D9] shadow-sm">
              <div className="flex justify-between items-center mb-8">
                <h4 className="text-sm font-black text-[#1C221F] uppercase tracking-widest">Giao dịch gần đây</h4>
                ...
                {transactions.length === 0 ? (
                  ...
                  <div key={idx} className="flex justify-between items-center group">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-xs font-bold text-[#1C221F] line-clamp-1">{tx.description || tx.type}</p>
              ...
              <button className="mt-10 w-full py-4 bg-white/5 border border-[#E8E3D9] text-gray-500 font-black rounded-2xl hover:bg-white/10 transition-all text-xs uppercase tracking-widest">
            ...
            <div className="bg-amber-500/5 p-8 rounded-[40px] border border-amber-500/20 shadow-xl shadow-amber-500/5">
              <div className="w-12 h-12 bg-amber-500 text-[#1C221F] rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-amber-500/20 animate-pulse">
                <AlertCircle size={24} />
              </div>
