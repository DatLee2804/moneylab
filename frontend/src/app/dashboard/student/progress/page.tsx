      ...
      <div className="max-w-7xl mx-auto space-y-8 uppercase">
        <div className="bg-white rounded-[40px] border border-[#E8E3D9] shadow-sm overflow-hidden">
          <div className="p-8 border-b border-[#E8E3D9]">
            <h3 className="text-xl font-black text-[#1C221F] uppercase tracking-tight">Tiến độ học tập chi tiết</h3>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50">
                  <th className="px-8 py-5 text-[10px] font-black text-gray-500 uppercase tracking-widest">STT</th>
                  <th className="px-8 py-5 text-[10px] font-black text-gray-500 uppercase tracking-widest">Tên khóa học</th>
                  <th className="px-8 py-5 text-[10px] font-black text-gray-500 uppercase tracking-widest">Ngày đăng ký</th>
                  <th className="px-8 py-5 text-[10px] font-black text-gray-500 uppercase tracking-widest">Tiến độ</th>
                  <th className="px-8 py-5 text-[10px] font-black text-gray-500 uppercase tracking-widest">Thao tác</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#E8E3D9]">
                {enrollments.length === 0 ? (
                  ...
                  <tr key={en.id} className="hover:bg-white/5 transition-colors group">
                    ...
                    <td className="px-8 py-6 text-sm font-black text-[#1C221F] group-hover:text-[#1C221F] transition-colors">{en.course.title}</td>
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center space-x-4">
                        <div className="w-32 h-2 bg-white/5 rounded-full overflow-hidden">
                          <div className="h-full bg-[#133E2B] transition-all" style={{ width: `${en.progress}%` }} />
                        </div>
                        <span className="text-xs font-black text-[#1C221F]">{en.progress}%</span>
                      </div>
                    </td>
                    <td className="px-8 py-6">
                      <Link href={`/courses/${en.course.id}/player`} className="flex items-center space-x-2 text-[#1C221F] hover:underline transition-all group-hover:translate-x-1 duration-300">
